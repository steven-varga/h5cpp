...
** Minimalistic file creation
   ...
   #+HEADERS: :results silent :exports code
   #+BEGIN_SRC C++ :includes <h5cpp/all> :flags "-std=c++17" :libs "-lhdf5"
...
** C-API interop
   ...
   #+BEGIN_SRC C++ :includes '(<h5cpp/all> <cassert> <iostream>) :flags "-std=c++17" :libs "-lhdf5"
