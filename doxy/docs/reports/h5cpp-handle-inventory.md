...
All 16 share `Kind = hdf5::property`. The classic variants implement the `|`
...
`H5Iall.hpp:353-358`. Same underlying `hid_t<T, capi_close, false, false, Kind>`
...
The remaining 10 property lists (`acpl_t`, `tapl_t`, `tcpl_t`, `fcpl_t`,
